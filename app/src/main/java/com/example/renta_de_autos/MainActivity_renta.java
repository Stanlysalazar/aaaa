package com.example.renta_de_autos;
...
public class MainActivity_renta extends AppCompatActivity {
    ...
    Button guardar_renta, buscar_renta, regresar_renta;
                                                        ...
                                                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                            if(task.isSuccessful()){
                                                                if(task.getResult().isEmpty()){
                                                                    ...
                                                                    Toast.makeText(MainActivity_renta.this, "Numero de renta registrado, ingrese uno nuevo!!", Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        }
                                                    });
                                                } else {
                                                    Toast.makeText(MainActivity_renta.this, "Numero de Placa no registrado o el automovil no esta disponible", Toast.LENGTH_SHORT).show();
                                                }
                                            } else {
                                                Toast.makeText(MainActivity_renta.this, "Numero de Placa no registrado o el automovil no esta disponible", Toast.LENGTH_SHORT).show();
                                            }
